            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
                <div>
                    ...
                    @if ($user->reservations->isEmpty())
                        <p class="text-sm text-gray-500">This user has no reservations.</p>
                    @else
                        <ul class="space-y-2">
                            @foreach ($user->reservations as $reservation)
                                <li class="border-b border-gray-200 pb-2">
                                    <p class="text-sm font-medium">{{ $reservation->service->name }}</p>
                                    <p class="text-xs text-gray-500">{{ $reservation->reservation_time }}</p>
                                </li>
                            @endforeach
                        </ul>
                    @endif
