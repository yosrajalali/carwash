    ...
    <div class="w-full max-w-md">
        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('register.check') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" name="password" type="password" placeholder="Password">
                @error('password')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password_confirmation" name="password_confirmation" type="password" placeholder="Confirm Password">
            ...
            <div class="flex items-center ">
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-4" type="submit">
                    Register
                </button>
                <p class="text-gray-600 text-sm">
                    Already have an account? <a href="{{ route('login.show') }}" class="text-blue-500 hover:underline">Login</a>
                </p>
            </div>
        </form>
    </div>
